            ...
            <div class="sidebar-content ">
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item">
                        <a href="#laporan" data-toggle="collapse" class="sidebar-link collapsed">
                            <i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Laporan</span>
                        </a>
                        <ul id="laporan" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
							<li <?= $this->session->flashdata('menu')=="laporan-produk"?"class=\"sidebar-item active\"":"class=\"sidebar-item\"" ?>><a href="<?= base_url('admin/laporan/produk'); ?>" class="sidebar-link">Laporan Penyewaan</a></li>
							<li <?= $this->session->flashdata('menu')=="laporan-customer"?"class=\"sidebar-item active\"":"class=\"sidebar-item\"" ?>><a href="<?= base_url('admin/laporan/customer'); ?>" class="sidebar-link">Laporan Customer</a></li>
							<li <?= $this->session->flashdata('menu')=="laporan-barangmasuk"?"class=\"sidebar-item active\"":"class=\"sidebar-item\"" ?>><a href="<?= base_url('admin/laporan/barangmasuk'); ?>" class="sidebar-link">Laporan Barang Masuk</a></li>
							<li <?= $this->session->flashdata('menu')=="laporan-barangkeluar"?"class=\"sidebar-item active\"":"class=\"sidebar-item\"" ?>><a href="<?= base_url('admin/laporan/barangkeluar'); ?>" class="sidebar-link">Laporan Barang Keluar</a></li>
                        </ul>
                    </li>
